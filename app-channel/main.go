...
func main() {
	...
	alice := setupGameClient(aliceBus, chainURL, adjudicator, asset, keyAlice, app, stake, aliceWireAcc.Address())
	bob := setupGameClient(bobBus, chainURL, adjudicator, asset, keyBob, app, stake, bobWireAcc.Address())
