...
import "./perun-eth-contracts/contracts/SafeMath64.sol";
import "./App.sol";
...
contract Adjudicator {
    ...
    public
    {
        ...
        require(hasApp(params), "must have app");
    ...
    public
    {
        ...
        if (hasApp(params)) {
            App(params.app).onConclude(params, state);
        }
    ...
    /**
     * @dev hasApp returns whether the channel defined by params has an app.
     */
    function hasApp(Channel.Params memory params) internal pure returns (bool) {
