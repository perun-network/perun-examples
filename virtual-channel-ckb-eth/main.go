...
import (
	...
	"perun.network/perun-examples/virtual-channel-ckb-eth/client"
	"perun.network/perun-examples/virtual-channel-ckb-eth/deployment"
	"perun.network/perun-examples/virtual-channel-ckb-eth/ethereumUtil"
)
...
const (
	...
	keyIngrid   = "1c8e5b9a7c3d2e4f8a1b2c3d4e5f67890abcdef1234567890abcdef123456789"
)
